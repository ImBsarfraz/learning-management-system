...
import { useGetSearchCoursesQuery } from '@/redux/features/api/courseApi';
...
const SearchPages = () => {
    ...
    // using state lifting up and controlled component approach
    const [selectedCategories, setSelectedCategories] = useState([]);
    const [sortByPrice, setSortByPrice] = useState("");
    // query variable name should be same as query inside the search
    ...
    return (
        <div className='mx-w-7xl mx-auto p-4 md:p-8'>
            <div>
